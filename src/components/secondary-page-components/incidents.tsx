...
interface IncidentsPageComponentProps {
...
export const IncidentsPageComponent = ({
  procoreData,
  qrCodeId,
  projectData,
  itemId,
}: IncidentsPageComponentProps) => {
            ...
            <div className="grid grid-cols-3 m-0 mx-auto gap-2 mb-2 px-4 rounded-lg shadow-md bg-gray-100 pb-4 border border-gray-300">
              ...
              <div className="flex flex-col items-start justify-self-start col-span-2">
                ...
                <span className="inline-flex items-center -mt-[3px] rounded-full text-lg">
                  {formatProcoreTime(data.event_date || "-")}
                </span>
              </div>
              <div className="flex flex-col items-start justify-self-start ml-6 col-span-1">
                <span className="text-xs text-yellow-900 font-[300]">
                ...
                <div className="mt-4">
                    ...
                    <div className=" space-y-2">
                      {data?.attachments?.length ? (
                        ...
                        <p className="text-sm text-gray-500">
                          No attachments available for this incident.
                        </p>
                      )}
                    </div>
                  )}
                  {activeTab === "more" && (
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-col justify-start items-start mt-1">
                        ...
                        <p className="font-medium text-gray-900  col-span-1">
                          {data?.contributing_behavior?.name || "-"}
                        </p>
                      </div>
                      <div className="flex flex-col justify-start items-start mt-1">
                        <span className="text-sm text-gray-500 col-span-1">
                        ...
                        <p className="font-medium text-gray-900 col-span-1">
                          {data?.contributing_condition?.name || "-"}
                        </p>
                      </div>
                    </div>
                  )}
                  ...
                  {activeTab === "links" && (
                    <div className="flex justify-center mt-4">
                      <a
                        href={`${import.meta.env.VITE_PROCORE_BASE_URL}/${projectData.procoreProjectID}/project/incidents/${itemId}`}
