...
export const ExternalLinkIcon: React.FC<ExternalLinkIconProps> = ({
  ...
  return (
    ...
    >
      <path
        d="M5.15.006c-2.801 0-5.072 2.273-5.072 5.074v53.841c0 2.803 2.271 5.073 5.072 5.073h45.775c2.801 0 5.074-2.271 5.074-5.073v-38.605l-18.903-20.31h-31.946z"
        fillRule="evenodd"
        clipRule="evenodd"
        fill="#0C8FE8"
      />
